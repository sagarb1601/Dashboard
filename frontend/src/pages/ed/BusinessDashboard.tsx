...
import ClientsTab from './business/ClientsTab';
import BusinessEntitiesTab from './business/BusinessEntitiesTab';
import InvoicesTab from './business/InvoicesTab';
import PaymentsTab from './business/PaymentsTab';
import BusinessDashboardTab from './business/BusinessDashboardTab';
    ...
    <div style={{ minHeight: '100vh', backgroundColor: '#f5f5f5' }}>
      ...
      <div style={{ padding: '0 24px' }}>
        <Tabs activeKey={activeTab} onChange={setActiveTab} style={{ marginTop: 0 }}>
          ...
          <TabPane tab="Business Entities" key="entities">
            <BusinessEntitiesTab />
          </TabPane>
