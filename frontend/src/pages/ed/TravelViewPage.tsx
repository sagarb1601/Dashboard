...
import EdTravelCalendarPage from './EdTravelCalendarPage';
import EdTravelListPage from './EdTravelListPage';
import { useAntDesignDropdownFix } from '../../utils/resizeObserverFix';

const { TabPane } = Tabs;

const TravelViewPage: React.FC = () => {
    ...
    <div style={{ minHeight: '100vh', backgroundColor: '#f5f5f5' }}>
      ...
      <div style={{ padding: '0 24px' }}>
        <Tabs activeKey={activeTab} onChange={setActiveTab} style={{ marginTop: 0 }}>
          <TabPane tab="Travel Calendar" key="calendar">
            <EdTravelCalendarPage />
          </TabPane>
          <TabPane tab="Travel Info" key="info">
            <EdTravelListPage />
          </TabPane>
        </Tabs>
      </div>
