...
import ExpenditureTab from './finance/ExpenditureTab';
import ProjectsTab from './finance/ProjectsTab';
import GrantsTab from './finance/GrantsTab';
import BudgetExpenditureTab from './finance/BudgetExpenditureTab';
import FinanceDashboardTab from './finance/FinanceDashboardTab';
import { useAntDesignDropdownFix } from '../../utils/resizeObserverFix';

const { TabPane } = Tabs;

const FinanceDashboardNew: React.FC = () => {
    ...
    <div style={{ minHeight: '100vh', backgroundColor: '#f5f5f5' }}>
      ...
      <div style={{ padding: '0 24px' }}>
        <Tabs activeKey={activeTab} onChange={setActiveTab} style={{ marginTop: 0 }}>
          ...
          <TabPane tab="Budget and Expenditure" key="budget-expenditure">
            <BudgetExpenditureTab />
          </TabPane>
...
export default FinanceDashboardNew; 