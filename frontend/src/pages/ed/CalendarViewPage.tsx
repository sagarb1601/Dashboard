...
import CalendarView from './EdCalendarPage';
import EdEventsPage from './EdEventsPage';
    ...
    <div style={{ minHeight: '100vh', backgroundColor: '#f5f5f5' }}>
      ...
      <div style={{ padding: '0 24px' }}>
        <Tabs activeKey={activeTab} onChange={setActiveTab} style={{ marginTop: 0 }}>
          <TabPane tab="Event Calendar" key="calendar">
            <CalendarView initialView={initialView} />
          </TabPane>
          <TabPane tab="Events Info" key="events">
            <EdEventsPage />
          </TabPane>
        </Tabs>
      </div>
