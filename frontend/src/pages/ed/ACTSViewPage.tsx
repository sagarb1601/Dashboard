...
import Courses from '../acts/Courses';
import ACTSDashboardPage from './ACTS/ACTSDashboardPage';
import { useAntDesignDropdownFix } from '../../utils/resizeObserverFix';

const { TabPane } = Tabs;

const ACTSViewPage: React.FC = () => {
  ...
  return (
    <div style={{ minHeight: '100vh', backgroundColor: '#f5f5f5' }}>
      ...
      <div style={{ padding: '0 24px' }}>
        ...
        <TabPane tab="Course Info" key="course-info">
            <Courses hideAddButton={true} />
          </TabPane>
