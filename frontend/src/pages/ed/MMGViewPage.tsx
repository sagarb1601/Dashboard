...
import MMGDashboardPage from './MMG/MMGDashboardPage';
import MMGIndentInfoPage from './MMG/MMGIndentInfoPage';
import { useAntDesignDropdownFix } from '../../utils/resizeObserverFix';

const { TabPane } = Tabs;

const MMGViewPage: React.FC = () => {
  const navigate = useNavigate();
  const location = useLocation();
  const [activeTab, setActiveTab] = useState('indent-info');
  ...
  return (
    <div style={{ minHeight: '100vh', backgroundColor: '#f5f5f5' }}>
      ...
      <div style={{ padding: '0 24px' }}>
        ...
        <TabPane tab="Indent Info" key="indent-info">
            <MMGIndentInfoPage />
          </TabPane>
