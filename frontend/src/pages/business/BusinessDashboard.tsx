          ...
          <Card sx={{ height: '100%', bgcolor: '#f8f9fa' }}>
            <CardContent sx={{ textAlign: 'center' }}>
              ...
              <Typography variant="h4" sx={{ color: '#9c27b0', fontWeight: 'bold' }}>
                {formatCurrency(summary?.total_order_value || 0)}
              </Typography>
              <Typography variant="body2" color="text.secondary">
                Total Order Value
              </Typography>
          ...
          <Card sx={{ height: '100%', bgcolor: '#f8f9fa' }}>
            <CardContent sx={{ textAlign: 'center' }}>
              ...
              <Typography variant="h4" sx={{ color: '#d32f2f', fontWeight: 'bold' }}>
                {formatCurrency(summary?.total_invoice_value || 0)}
              </Typography>
              <Typography variant="body2" color="text.secondary">
                Invoice Value
              </Typography>
          ...
          <Card sx={{ height: '100%', bgcolor: '#f8f9fa' }}>
            <CardContent sx={{ textAlign: 'center' }}>
              ...
              <Typography variant="h4" sx={{ color: '#388e3c', fontWeight: 'bold' }}>
                {formatCurrency(summary?.total_payments_received || 0)}
              </Typography>
              <Typography variant="body2" color="text.secondary">
                Payments Received
              </Typography>
            ...
            <CardContent>
              ...
              <ResponsiveContainer width="100%" height={300}>
                <LineChart data={invoiceValuePerMonth}>
                  ...
                  <XAxis dataKey="month" />
                  <YAxis />
                  <Tooltip formatter={(value) => [formatCurrency(Number(value)), 'Invoice Value']} />
